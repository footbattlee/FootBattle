...
export default function HomeQuickAccess() {
  ...
  return (
    <>
      ...
      {/* Mobil/tablet: mevcut hızlı erişim yapısı aynen korunuyor. */}
      ...
      {/* Desktop alt hızlı erişim: yalnızca yardımcı araçlar burada kalıyor. */}
      <div className="fixed bottom-5 left-5 z-[70] hidden xl:block">
        <div className="flex items-center gap-2 rounded-2xl border border-white/10 bg-[#081523]/95 p-2 shadow-2xl backdrop-blur-xl">
          ...
          <Link href="/halisaha-mac" className="inline-flex min-h-11 items-center gap-2 rounded-xl border border-green-400/20 bg-green-400/10 px-4 text-sm font-black text-green-300">⚽ {tr ? "Halısaha" : "Pickup Match"}</Link>
