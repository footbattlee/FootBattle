...
export const metadata = createGameMetadata({
  ...
  description,
  keywords: ["futbol oyunları", "online futbol oyunları", "penaltı oyunu", "futbol quiz", "futbolcu tahmin", "football wordle", "futbol bilgi oyunu"],
});
  ...
  return (
    <>
      ...
      <SeoLandingPage
        ...
        intro="FootBattle, futbol bilgisi, refleks ve arkadaş rekabetini kısa oyunlarda buluşturan bir futbol oyunları platformu. Penaltı at veya kaleci ol, futbolcu tahmin et, Wordle çöz, kariyer yolundan oyuncu bul, Tic Tac Toe oyna, kapışmalarda oy ver veya 16'lı Survivor turnuvasında kendi şampiyonunu çıkar."
        ctaHref="/"
        ctaLabel="Tüm Oyunları Gör ⚽"
        sections={[
          { title: "Penaltı ve refleks oyunları", paragraphs: ["FootBattle Penaltı, futbol bilgisinden çok karar verme ve refleks üzerine kurulu hızlı bir oyun modudur. Penaltı At modunda kaleciyi geçmeye çalışır, Kaleci Ol modunda şut yönünü okuyup doğru köşeye uzanırsın.", "Arkadaşınla Oyna modunda ise aynı cihazı sırayla kullanarak şutör ve kaleci rollerini paylaşırsın. Böylece bilgi oyunlarının yanında doğrudan futbol aksiyonuna dayalı kısa bir rekabet seçeneği de bulunur."], bullets: ["Penaltı At", "Kaleci Ol", "Arkadaşınla Oyna", "10 şutluk kısa turlar"] },
        ...
        faqs={[
          ...
          { question: "Hangi futbol oyunları var?", answer: "Penaltı, Guess The Player, Player Quiz, Football Wordle, Career Path, Kulüp x Ülke, Tic Tac Toe, Transfer Quiz, Günün Kapışması ve Survivor gibi modlar bulunur." },
          { question: "Arkadaşlarımla oynayabilir miyim?", answer: "Bazı oyunlarda düello ve paylaşım özellikleri bulunur; ayrıca Penaltı'nın Arkadaşınla Oyna modunda aynı cihazda karşılıklı oynayabilirsin." }
        ]}
        relatedLinks={[
