...
function serializeRound(
  ...
  return {
    ...
    challengerAnswerPlayerId:
      round.challenger_answer_player_id
        ? Number(
            round.challenger_answer_player_id,
          )
        : null,
    ...
    opponentAnswerPlayerId:
      round.opponent_answer_player_id
        ? Number(
            round.opponent_answer_player_id,
          )
        : null,
    ...
    challengerAnsweredAt:
      round.challenger_answered_at,

    opponentAnsweredAt:
      round.opponent_answered_at,
...
export async function GET(
  ...
  try {
    ...
    if (challengeError) {
      console.error(
        "Guest Club Clash challenge sorgu hatası:",
        challengeError,
      );
    ...
    if (roundsError) {
      console.error(
        "Guest Club Clash rounds sorgu hatası:",
        roundsError,
      );
    ...
    /* =====================================================
       ...
       DB'deki skorla birlikte roundlardan da hesaplıyoruz.
       Böylece frontend her zaman güncel durumu görür.
    ===================================================== */
    ...
    console.error(
      "Guest Club Clash GET endpoint hatası:",
      error,
    );
