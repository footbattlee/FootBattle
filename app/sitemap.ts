...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const pages: Array<{ path: string; changeFrequency: "daily" | "weekly"; priority: number }> = [
    ...
    { path: "/firsatlar", changeFrequency: "daily", priority: 0.85 },
    ...
    { path: "/en/premier-league", changeFrequency: "daily", priority: 0.95 },
    { path: "/tr/la-liga", changeFrequency: "daily", priority: 0.95 },
    { path: "/en/la-liga", changeFrequency: "daily", priority: 0.95 },
    { path: "/tr/serie-a", changeFrequency: "daily", priority: 0.95 },
    { path: "/en/serie-a", changeFrequency: "daily", priority: 0.95 },
    { path: "/tr/bundesliga", changeFrequency: "daily", priority: 0.95 },
    { path: "/en/bundesliga", changeFrequency: "daily", priority: 0.95 },
    { path: "/tr/ligue-1", changeFrequency: "daily", priority: 0.95 },
    { path: "/en/ligue-1", changeFrequency: "daily", priority: 0.95 },
    { path: "/tr/primeira-liga", changeFrequency: "daily", priority: 0.92 },
    { path: "/en/primeira-liga", changeFrequency: "daily", priority: 0.92 },
    { path: "/tr/champions-league", changeFrequency: "daily", priority: 0.98 },
    { path: "/en/champions-league", changeFrequency: "daily", priority: 0.98 },
    { path: "/tr/europa-league", changeFrequency: "daily", priority: 0.96 },
    { path: "/en/europa-league", changeFrequency: "daily", priority: 0.96 },
    { path: "/tr/conference-league", changeFrequency: "daily", priority: 0.94 },
