...
export const metadata: Metadata = {
  ...
  title: {
    default: "FootBattle | Futbol Oyunları, Quizler ve Arkadaş Kapışmaları",
    template: "%s | FootBattle",
  },
  description:
    "Guess The Player, Futbol Wordle, Tic Tac Toe, Career Path, Transfer Quiz, Günün Kapışması ve futbol Survivor oyunlarını ücretsiz oyna. Arkadaşlarına meydan oku.",
  ...
  openGraph: {
    ...
    description:
      "Futbol bilgini test et, arkadaşlarına meydan oku ve her gün yeni futbol kapışmalarına katıl.",
    url: SITE_URL,
    images: [
      {
        url: "/footbattle-logo.png",
        alt: "FootBattle futbol oyunları arenası",
      },
    ],
  },
  twitter: {
    ...
    title: "FootBattle | Futbol Oyunları Arenası",
    description: "Futbol oyunları, quizler, düellolar ve günlük kapışmalar.",
    images: ["/footbattle-logo.png"],
  },
  robots: {
    index: true,
    follow: true,
